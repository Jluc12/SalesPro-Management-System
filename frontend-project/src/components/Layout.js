      ...
      >
        <div className="flex items-center justify-between px-5 h-16 border-b border-slate-700/50 shrink-0">
          <div className={`flex items-center gap-3 ${!sidebarOpen && 'lg:hidden'}`}>
            ...
            <div>
              <h1 className="font-bold text-base leading-none text-white">SalePro</h1>
              <p className="text-[10px] text-blue-300/80 mt-0.5">Management System</p>
            </div>
          </div>
          <button
        ...
        <div className="border-t border-slate-700/50 px-4 py-3">
          ...
          <button
            ...
            className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm text-red-300 hover:text-red-200 hover:bg-red-500/10 transition-all duration-200"
          >
